...
RSpec.describe IMF::Image, '.detect_format' do
  ...
  context 'Given "fixtures/vimlogo-141x141.gif"' do
    it 'returns :gif' do
      expect(IMF::Image.detect_format("spec/fixtures/vimlogo-141x141.gif")).to eq(:gif)
    end
  end
  ...
  context 'Given a IO object of GIF file' do
    context 'When the IO object is readable' do
      it 'returns :gif and does not close the passed IO object' do
        open("spec/fixtures/vimlogo-141x141.gif", "rb") do |io|
    ...
    context 'When the IO object is not readable' do
      it 'raises IOError and does not close the passed IO object' do
        Dir.mktmpdir do |tmpdir|
          FileUtils.cp("spec/fixtures/vimlogo-141x141.gif", File.join(tmpdir, "tmp.gif"))
  ...
  context 'Given a StringIO object of GIF file' do
    it 'returns :gif' do
      strio = StringIO.new(IO.read("spec/fixtures/vimlogo-141x141.gif", mode: "rb"))
  ...
  context 'Given a Zlib::GzipReader object of Gzipped GIF file' do
    it 'returns :gif and does not close the passed IO object' do
      Zlib::GzipReader.open("spec/fixtures/vimlogo-141x141.gif.gz") do |gzio|
  ...
  context 'Given "fixtures/momosan.jpg"' do
    it 'returns :jpeg' do
      expect(IMF::Image.detect_format("spec/fixtures/momosan.jpg")).to eq(:jpeg)
    end
  end

  context 'Given "fixtures/vimlogo-141x141.png"' do
    it 'returns :png' do
      expect(IMF::Image.detect_format("spec/fixtures/vimlogo-141x141.png")).to eq(:png)
    end
  end

  context 'Given "fixtures/momosan.webp"' do
    it 'returns :webp' do
      expect(IMF::Image.detect_format("spec/fixtures/momosan.webp")).to eq(:webp)
    end
  end

  context 'Given "fixtures/not_image.txt"' do
    it 'returns nil' do
      expect(IMF::Image.detect_format("spec/fixtures/not_image.txt")).to eq(nil)
    end
  end
end
